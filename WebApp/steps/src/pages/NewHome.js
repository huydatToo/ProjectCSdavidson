...
const NewHome = () => {
    ...
    return (
        <div className='backgroundNew center'>
            <div className='boxes'>
                <div class="bentogrid">
                    <div className='box boxCreateNewProject' data-bento="1x1">
                        <h1 className='boxTitle'>Create <br /> New Project</h1>
                    </div>
                    ...
                    <div className='box' data-bento="1x2">
                        <div className='box-projects'>
                            ...
                            <div onClick={() => {navigate(`project/${item}`)}} key={index} whileHover={{scale: 1.05}} initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", duration: 0.7 }} className='project-box-load'>
